...
<script>
    ...
    $.getJSON("doctorController/selectAllDoctor",{type:''},function(data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            str3=str3+"<div  class=\"col-lg-4 col-md-6 col-12\">" +
                ...
                "                    <div class=\"t-head\"> <img src= '<%=basePath%>"+data[i].doctor_img+"'>" +
                "                    </div>" +
                "                    <div class=\"t-bottom\">" +
                "                        <p>"+data[i].dept_name+"</p>" +
                "                        <p>"+data[i].rank_name+"</p>" +
                "                        <h2><a href=\"doctorController/selectDoctorById?check=1&&doctor_id="+data[i].doctor_id+"\">"+data[i].doctor_name+"</a></h2>" +
                "                    </div>" +
                "                </div>" +
                "            </div>";
        }
                            ...
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li class="active"><a href="showAllDoctor.jsp">医生介绍<i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
                                            <li class="active"><a href="showAllDoctor.jsp">所有医生</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-team">
                    <div class="t-head" >
                        ...
                        <div class="t-icon">
                            <a href="appointment.html" class="btn">点击预约</a>
                        </div>
                    </div>
                    <div class="t-bottom">
                        <p>医生部门</p>
                        <p>医生职称</p>
                        <h2><a href="">这里填入的是医生的姓名Collis Molate</a></h2>
                    </div>
                </div>
                <!-- End Single Team -->
            </div>
