...
<script>
    ...
    $.getJSON("rankController/selectAllRank1",{type:''},function(data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            str3=str3+"<div  class=\"col-lg-4 col-md-6 col-12\">" +
                ...
                "                        <h2><a href=\"doctorController/selectDoctorByRankId?check=1&&rank_id="+data[i].rank_id+"\">"+data[i].rank_name+"</a></h2>" +
                "                    </div>" +
                "                </div>" +
                "            </div>";
        }
                        ...
                        <div class="main-menu">
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li class="active"><a href="showRank.jsp">职称 <i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
