...
<script>
    ...
    $.getJSON("deptController/selectAllDept",{type:''},function(data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            "                        <h2><a href=\"doctorController/selectDoctorByDeptId?check=1&&dept_id="+data[i].dept_id+"\">"+data[i].dept_name+"</a></h2>" +
            "                    </div>" +
            "                </div>" +
            "            </div>";
        }
                        ...
                        <div class="main-menu">
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li class="active"><a href="showDept.jsp">科室介绍 <i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
