                        ...
                        <div class="main-menu">
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <c:if test="${user ==null}">
                                        <li class="active"><a href="login.jsp">登录 </a>
                                        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-form">
                        <h2>登录</h2>
                        <p>还没有账号,这边注册 <a href="register.jsp">去注册</a></p>
                        <!-- Form -->
                        <form class="form" method="post"  action="changeController/loginChange">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input type="text" name="phone" placeholder="账号（电话）">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="checkbox">
                                            <input name="check" id="1" type="radio" value="1" checked="checked">患者
                                            <input name="check" id="2" type="radio" value="2">医生
                                            <input name="check" id="3" type="radio" value="3">管理员
                                    </div>
