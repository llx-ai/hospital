...
<section id="team" class="team section single-page">
    <div class="container">
        ...
        <c:if test="${empty sessionScope.doctorShowList}">
        没有医生信息！
        </c:if>
        ...
        <div class="row" id="doctor">
            ...
            <c:forEach items="${sessionScope.doctorShowList}" var="s">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-team">
                        <div class="t-head" >
                            <img src="<%=basePath%>${s.doctor_img}" alt="#">

                        </div>
                        <div class="t-bottom">
                            <p>${s.dept_name}</p>
                            <p>${s.rank_name}</p>
                            <h2><a href="doctorController/selectDoctorById?check=0&&doctor_id=${s.doctor_id}">${s.doctor_name}</a></h2>
                        </div>
                    </div>
                </div>
