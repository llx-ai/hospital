...
<script>
    function gotoappointment(doctor_id,weekId,dateId) {
        ...
        console.log("今天的日期："+day_today)

        //获取今天的星期
        var week_today = date.getDay();
        console.log("今天的星期："+week_today)
        if(week_today == 0){
            week_today = 7
        }
        if(month_today <10){
        ...
        //获取选中的日期
        if(week_today < weekId){
            var day_select = day_today + weekId - week_today
        }else if(week_today >= weekId){
            var day_select = day_today + weekId - week_today + 7
        }
        console.log("选中的日期为："+day_select)

        if(day_select <10){
            day_select = "0"+day_select
        }

        if(dateId == 1){
            var date_fin_str = year_today +'-'+month_today+'-'+day_select+' 08:00:00'
        }else {
            var date_fin_str = year_today +'-'+month_today+'-'+day_select+' 14:00:00'
        }
        //最终时间格式化
        var date_fin = new Date(date_fin_str)

        var time=date_fin_str
...
<script>
    ...
    $(document).ready(function(){
        ...
        var t='当前时间：'+year_today+'年'+month_today+'月'+day_today+'日'+str
                        ...
                        <div class="main-menu">
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li class="active"><a href="showAllDoctor.jsp">医生介绍<i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
