    ...
    $.getJSON("doctorController/selectAllDoctor",{type:''},function(data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            str3=str3+"<div  class=\"col-lg-4 col-md-6 col-12\">" +
                ...
                "                        <h2><a href=\"doctorController/selectDoctorById?check=0&&doctor_id="+data[i].doctor_id+"\">"+data[i].doctor_name+"</a></h2>" +
                "                    </div>" +
                "                </div>" +
                "            </div>";
        }
                            ...
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li class="active"><a href="showAllDoctorByDoctor.jsp">医生介绍<i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
                                            <li class="active"><a href="showAllDoctorByDoctor.jsp">所有医生</a></li>
                                        </ul>
                                    </li>
