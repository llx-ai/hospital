    ...
    $(document).ready(function() {
        ...
        $.getJSON("rankController/selectAllRank1", {type: 'rank'}, function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                "                        <h2><a href=\"doctorController/selectDoctorByRankId?check=0&&rank_id=" + data[i].rank_id + "\">" + data[i].rank_name + "</a></h2>" +
                "                    </div>" +
                "                </div>" +
                "            </div>";
            }
                        ...
                        <div class="main-menu">
                            <nav class="navigation">
                                <ul class="nav menu">
                                    ...
                                    <li class="active"><a href="showRankByDoctor.jsp">职称 <i class="icofont-rounded-down"></i></a>
                                        <ul class="dropdown">
